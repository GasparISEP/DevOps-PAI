...
public class US10_IWantToConfigureDegreeTypesLevelsController_2 {

    private final DegreeTypeRepository_2 degreeTypeRepository;

    public US10_IWantToConfigureDegreeTypesLevelsController_2(DegreeTypeRepository_2 degreeTypeRepository) {
