...
public record TeacherWithRelevantDataRequestDTO(
        ...
        @NotBlank(message = "Teacher Category ID cannot be blank.")
        String teacherCategoryID,

        @NotBlank(message = "Working Percentage cannot be blank.")
        String workingPercentage
