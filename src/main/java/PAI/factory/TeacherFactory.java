...
public class TeacherFactory implements TeacherFactoryInterface {
    ...
    public Teacher createTeacher(String acronym, String name, String email, String nif, String phoneNumber,
                                 ...
                                 Department department, TeacherCareerProgressionFactory teacherCareerProgressionfactory,
        ...
        return new Teacher(acronym, name, email, nif, phoneNumber, academicBackground, street, postalCode,
                location, country, addressFactory, date, category, workingPercentage, department, teacherCareerProgressionfactory, teacherCareerProgressionListFactory);
    }
}
