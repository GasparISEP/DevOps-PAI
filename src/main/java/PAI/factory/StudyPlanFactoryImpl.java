...
public class StudyPlanFactoryImpl implements StudyPlanFactory {
    ...
    public StudyPlan newStudyPlan(CourseInStudyPlanFactoryImpl courseInStudyPlanFactory, StudyPlanListFactoryImpl studyPlanArrayListFactory, CourseFactory courseFactory) {
