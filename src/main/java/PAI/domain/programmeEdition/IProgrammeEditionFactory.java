...
public interface IProgrammeEditionFactory {
    ...
    ProgrammeEdition createProgrammeEdition(ProgrammeEditionID programmeEditionID, ProgrammeID programmeID,
                                            SchoolYearID schoolYearID, ProgrammeEditionGeneratedID programmeEditionGeneratedID) throws Exception;
}
