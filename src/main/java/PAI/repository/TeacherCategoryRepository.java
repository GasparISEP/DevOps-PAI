...
public class TeacherCategoryRepository {
    ...
    public TeacherCategoryRepository(TeacherCategoryFactoryImpl teacherCategoryFactory, TeacherCategoryRepositoryListFactory teacherCategoryRepositoryListFactory) {
