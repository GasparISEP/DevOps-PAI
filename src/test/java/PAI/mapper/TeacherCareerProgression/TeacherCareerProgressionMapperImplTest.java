...
class TeacherCareerProgressionMapperImplTest {
    ...
    private final ITeacherCareerProgressionFactory tcpFactory = mock(ITeacherCareerProgressionFactory.class);
    private final ITeacherCareerProgressionIDMapper idMapper = mock(ITeacherCareerProgressionIDMapper.class);
    private final TeacherCareerProgressionMapperImpl mapper = new TeacherCareerProgressionMapperImpl(tcpFactory, idMapper);
    ...
    void shouldReturnNonNullDataModelObject() {
        ...
        TeacherCareerProgressionMapperImpl mapper = new TeacherCareerProgressionMapperImpl(mock(ITeacherCareerProgressionFactory.class), mock(ITeacherCareerProgressionIDMapper.class));
