...
//
//        when(schoolYearDataModel.getId()).thenReturn(UUID.randomUUID().toString());
...
//
//        SchoolYearDataModel model = mapper.toDataModel(schoolYear);
//        assertEquals(model.getId(), uuid.toString());
//        assertEquals(model.getDescription(), description);
//        assertEquals(model.getStartDate(), startDate);
//        assertEquals(model.getEndDate(), endDate);
//    }
...
//        LocalDate endDate = LocalDate.of(2025, 1, 1);
//
//        SchoolYearDataModel schoolYearDataModel = new SchoolYearDataModel(uuid, description, startDate, endDate);
//
//        SchoolYear schoolYear = mapper.toDomain(schoolYearDataModel, schoolYearFactory);
//
//        assertEquals(schoolYear.identity().getSchoolYearID().toString(),uuid);
