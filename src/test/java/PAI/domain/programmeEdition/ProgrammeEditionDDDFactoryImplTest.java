...
class ProgrammeEditionDDDFactoryImplTest {
    ...
    void shouldCreateProgrammeEdition() throws Exception {
        ...
        try (MockedConstruction<ProgrammeEditionID> programmeEditionIDMocked = mockConstruction(ProgrammeEditionID.class);
             MockedConstruction<ProgrammeEditionDDD> programmeEditionDDDMocked = mockConstruction(ProgrammeEditionDDD.class, (mock, context) -> {
            ...
            IProgrammeEditionDDDFactory factory = new ProgrammeEditionDDDFactoryImpl();

            // Act
            ProgrammeEditionDDD pE = factory.createProgrammeEdition(pID, sYID);
