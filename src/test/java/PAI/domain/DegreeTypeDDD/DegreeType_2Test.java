...
class DegreeType_2Test {
    ...
    void shouldCreateValidDegreeType() throws Exception {
        ...
        DegreeType_2 degreeType = new DegreeType_2(id, name, maxEcts);
    ...
    void shouldThrowExceptionWhenCreatingWithNullValues() throws Exception {
        ...
        assertThrows(NullPointerException.class, () -> new DegreeType_2(null, validName, validMaxEcts));
        assertThrows(NullPointerException.class, () -> new DegreeType_2(validID, null, validMaxEcts));
        assertThrows(NullPointerException.class, () -> new DegreeType_2(validID, validName, null));
    }
    ...
    void shouldReturnTrueForEqualObjects() throws Exception {
        ...
        DegreeType_2 degreeType1 = new DegreeType_2(id1, name1, maxEcts1);
        DegreeType_2 degreeType2 = new DegreeType_2(id1, name1, maxEcts1);
    ...
    void shouldReturnFalseForDifferentObjects() throws Exception {
        DegreeType_2 degreeType1 = new DegreeType_2(new DegreeTypeID("DT1"), new Name("Bachelor"), new MaxEcts(180));
        DegreeType_2 degreeType2 = new DegreeType_2(new DegreeTypeID("DT2"), new Name("Master"), new MaxEcts(120));
