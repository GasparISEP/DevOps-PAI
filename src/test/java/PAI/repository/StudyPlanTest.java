...
class StudyPlanTest {
    ...
    void shouldRegisterCourseInStudyPlan() throws Exception {
        ...
        StudyPlan studyPlan = new StudyPlan(courseInStudyPlanFactory, studyPlanListFactory, courseFactoryImpl);
    ...
    void shouldAllowRegisterAnnualCourseSpanningTwoSemesters() throws Exception {
        ...
        when(courseFactoryImpl.createCourse("Annual Course", "ANNUAL", 5.0, 1))
