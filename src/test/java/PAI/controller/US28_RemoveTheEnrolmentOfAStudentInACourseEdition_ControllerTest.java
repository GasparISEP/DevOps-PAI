...
// ==============================
    ...
    @Test
    public void removeActiveEnrolment_ShouldDeactivateOnlyCourseEnrolment() throws Exception {
        // Arrange
        ...
        // Assert
        assertTrue(result, "Active enrolment should be deactivated.");
    }

//    // Remove Last Active Course Edition Enrolment
//    @Test
//    public void removeLastActiveCourseEdition_ShouldDeactivateProgrammeEnrolment() throws Exception {
//        // Arrange
//        ICourseEditionEnrolmentService mockService = mock(ICourseEditionEnrolmentService.class);
//        StudentID mockStudentID = mock(StudentID.class);
//        CourseEditionID mockCourseEditionID = mock(CourseEditionID.class);
...
//
//        // Assert
//        assertTrue(result, "Removing last active course edition should deactivate programme enrolment.");
//        verify(mockService, times(1)).removeProgrammeEditionEnrolment(mockStudentID, mockCourseEditionID.getProgrammeEditionID());
//    }
...
//            US28_RemoveTheEnrolmentOfAStudentInACourseEditionController controller = new US28_RemoveTheEnrolmentOfAStudentInACourseEditionController(mockRepository);
//
//            StudentID mockStudentID = mock(StudentID.class);
//            CourseEditionID mockCourseEditionID = mock(CourseEditionID.class);
//
