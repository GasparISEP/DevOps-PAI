...
class US17_EnrolStudentInProgrammeEditionAndSetOfCoursesEditionsControllerTest {
    ...
    void testEnrolStudentInProgrammeEditionAndSetOfCoursesEditions_Success() {
        ...
        CourseEdition_2 doubleCe2 = mock(CourseEdition_2.class);
        ...
        when(doubleCourseEditionEnrolmentRepository.isStudentEnrolledInCourseEdition(doubleStudentID, doubleCe1)).thenReturn(true);

        when(doubleCourseEditionEnrolmentRepository.isStudentEnrolledInCourseEdition(doubleStudentID, doubleCe2)).thenReturn(true);
        ...
        boolean result2 = doubleCourseEditionEnrolmentRepository.isStudentEnrolledInCourseEdition(doubleStudentID, doubleCe1);
        boolean result3 = doubleCourseEditionEnrolmentRepository.isStudentEnrolledInCourseEdition(doubleStudentID, doubleCe2);
    ...
    void testEnrolStudentInProgrammeEditionAndSetOfCoursesEditions_Success_IntegrationTest() throws Exception {
        ...
        PhoneNumber phoneNumber = new PhoneNumber("+351","221234567");
        Email email = new Email("joao123@gmail.com");
        AccessMethodID accessMethodID = new AccessMethodID();
        ProgrammeID programmeID = new ProgrammeID();

        Student student = new Student(studentID, name, nif, phoneNumber, email, add1, studentAcademicEmail);
        ...
        if (!programmeEnrolmentRepository.isStudentEnrolled(student, programme1)) {
            programmeEnrolmentRepository.enrolStudents(studentID, accessMethodID, programmeID, date);
        }
        ...
        CourseEdition_2 ce1 = courseEditionRepository.getCourseEditions().get(0);
        CourseEdition_2 ce2 = courseEditionRepository.getCourseEditions().get(1);

        // Act
        boolean result = controller.enrolStudentInProgrammeEditionAndSetOfCoursesEditions(student, programme1, schoolYear);
        boolean result2 = courseEditionEnrolmentRepository.isStudentEnrolledInCourseEdition(studentID, ce1);
        boolean result3 = courseEditionEnrolmentRepository.isStudentEnrolledInCourseEdition(studentID, ce2);
