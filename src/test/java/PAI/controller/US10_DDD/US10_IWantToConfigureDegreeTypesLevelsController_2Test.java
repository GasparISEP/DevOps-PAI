...
class US10_IWantToConfigureDegreeTypesLevelsController_2Test {

    private DegreeTypeRepository_2 degreeTypeRepositoryMock;
    private US10_IWantToConfigureDegreeTypesLevelsController_2 controller;

    @BeforeEach
    void setUp() {
        degreeTypeRepositoryMock = Mockito.mock(DegreeTypeRepository_2.class);
        controller = new US10_IWantToConfigureDegreeTypesLevelsController_2(degreeTypeRepositoryMock);
    }
