...
class US11_RegisterProgrammeInTheSystemTest {
    ...
    void testRegisterProgrammeInTheSystemCorrectly() throws Exception{
        ...
        boolean result = controller1.registerProgrammeInTheSystem(name, acronym, quantityOfEcts, quantityOfSemesters, degreeType, department, teacher, programmeCourseListFactoryImpl);
