...
describe('Teachers Management - Non-Happy Paths', () => {
    ...
    it('exibe erro ao tentar registar novamente o mesmo teacher', () => {
        const teacher = {
            name: 'Cypress Switch Dev',
            acronym: 'CSD',
            email: 'cypressswitchdev@isep.ipp.pt',
            nif: '124192426',
            academicBackground: 'Licenciatura Engenharia Informática',
